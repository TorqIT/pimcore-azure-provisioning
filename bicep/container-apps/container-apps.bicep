...
var databaseUrlSecret = {
  ...
  value: 'mysql://${databaseUser}:${databasePasswordSecretInKeyVault.properties.value}@${databaseServerName}.mysql.database.azure.com:3306/${databaseName}?ssl-ca=/var/www/html/config/db/DigiCertGlobalRootCA.crt.pem'
}
